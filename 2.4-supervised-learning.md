...
X1, X2, …, Xn이 각각 독립이고 같은 확률 분포를 가지고 있으면 가능도 L은![](https://miro.medium.com/max/60/1*ElcXcCrDdWpnPu2tlzD5Fg.png?q=20)![](https://miro.medium.com/max/6344/1*ElcXcCrDdWpnPu2tlzD5Fg.png)
